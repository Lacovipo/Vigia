...
| 7.3 — corpus v3 | **en marcha**: 36 M jugados y etiquetados por 0.32 a 25.000 nodos, **~11,4 h** con 8 CPUs (394.468 registros/h/hilo con la máquina tranquila; los 328.900 que se anotaron al principio se midieron con una revisión adversarial mía corriendo a la vez). Después, dos redes a 60 épocas con λ = 0,75 —v1+v2+v3 y v2+v3— y banco contra 0.32. Esa pareja es además la primera medida limpia de lo que aporta el volumen. Plan en la fase 7, punto 2 |
