...
| 7.3 — corpus v3 | **preparada**: 36 M jugados y etiquetados por 0.32 a 25.000 nodos, ~13 h con 8 CPUs (ritmo calibrado: 348.777 registros/h/hilo). Después, dos redes a 60 épocas con λ = 0,75 —v1+v2+v3 y v2+v3— y banco contra 0.32. Plan en la fase 7, punto 2, del plan |
