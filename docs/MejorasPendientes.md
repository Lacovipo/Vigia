...
| 7.3 — corpus v3 | **en marcha**: 36 M jugados y etiquetados por 0.32 a 25.000 nodos, **~13,7 h** con 8 CPUs (328.900 registros/h/hilo reales con 8 hilos, frente a 348.777 calibrados con 2). Después, dos redes a 60 épocas con λ = 0,75 —v1+v2+v3 y v2+v3— y banco contra 0.32. Esa pareja es además la primera medida limpia de lo que aporta el volumen. Plan en la fase 7, punto 2 |
